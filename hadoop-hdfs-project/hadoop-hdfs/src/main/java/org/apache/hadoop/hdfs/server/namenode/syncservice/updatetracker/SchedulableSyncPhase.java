...
public class SchedulableSyncPhase {
  ...
  public static SchedulableSyncPhase empty() {
    return new SchedulableSyncPhase(Lists.newArrayList(), Lists.newArrayList());
  }

  public static SchedulableSyncPhase create(List<MetadataSyncTask> metadataSyncTaskList,
      List<BlockSyncTask> blockSyncTaskList) {
    return new SchedulableSyncPhase(metadataSyncTaskList, blockSyncTaskList);
  }

  public static SchedulableSyncPhase createBlock(List<BlockSyncTask> blockSyncTasks) {
    return new SchedulableSyncPhase(Lists.newArrayList(), blockSyncTasks);
  }

  public static SchedulableSyncPhase createMeta(List<MetadataSyncTask> metadataSyncTasks) {
