...
/**
 * A SyncTask is an Synchonization operation that is tracked by the Namenode.
 */
public abstract class SyncTask implements TrackableTask {
  ...
  public static class TouchFileSyncTask extends SyncTask {
    ...
    public TouchFileSyncTask(UUID syncTaskId, URI uri, String syncMountId, long blockCollectionId) {
  ...
  public static class DeleteDirectorySyncTask extends SyncTask {
    public DeleteDirectorySyncTask(UUID syncTaskId, URI uri, String syncMountId) {
      super(syncTaskId, DELETE_DIRECTORY, uri, syncMountId);
    }
  }

  public static class CreateDirectorySyncTask extends SyncTask {
    public CreateDirectorySyncTask(UUID syncTaskId, URI uri, String syncMountId) {
  ...
  public static class RenameDirectorySyncTask extends SyncTask {
    ...
    public RenameDirectorySyncTask(UUID syncTaskId, URI uri, URI renamedTo, String syncMountId) {
